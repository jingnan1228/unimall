...
public class AdminGoodsServiceImpl implements AdminGoodsService {
    ...
    public String create(SpuDTO spuDTO, Long adminId) throws ServiceException {
        ...
        if (spuDTO.getOriginalPrice().intValue() < spuDTO.getPrice().intValue() || spuDTO.getPrice().intValue() < spuDTO.getVipPrice().intValue() || spuDTO.getOriginalPrice().intValue() < spuDTO.getVipPrice().intValue()) {
        ...
        for (SkuDO skuDO : spuDTO.getSkuList()) {
            if (skuDO.getOriginalPrice().intValue() < skuDO.getPrice().intValue() || skuDO.getPrice().intValue() < skuDO.getVipPrice().intValue() || skuDO.getOriginalPrice().intValue() < skuDO.getVipPrice().intValue()) {
                throw new AdminServiceException(ExceptionDefinition.GOODS_PRICE_CHECKED_FAILED);
            }
