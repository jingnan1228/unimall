    ...
    <view class="container">  
		<view class="user-section">
			...
			<view class="vip-card-box">
				...
				<text class="e-m">店主用户</text>
				<text class="e-b">{{isVip ? '店主专享VIP价' : '请完成任务成为我们的一员'}}</text>
			</view>
		</view>
		...
		>
			...
			<view class="order-section">
				...
				<view class="order-item" @click="navTo('/pages/order/')"  hover-class="common-hover" :hover-stay-time="50">
			 ...
			 <view class="history-section icon">
				...
				<list-cell icon="icon-shoucang_xuanzhongzhuangtai" iconColor="#5fcda2" title="订单管理" @eventClick="navTo('/pages/order/list?state=0')"></list-cell>
				...
				<list-cell icon="icon-iconfontweixin" iconColor="#EEEE00" title="分销中心" @eventClick="navTo('/pages/integral/integral')"></list-cell>
